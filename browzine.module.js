angular.module('browzineMod', [])
  ...
  .component('browzineMod', {
    ...
    template: "<div class='browzine' style='line-height: 1.4em; margin-right: 4.5em;'           ng-if='$ctrl.isArticleTF && $window.browzine.articlePDFDownloadLinkEnabled && $ctrl.browzineEnabled && $ctrl.directToPDFUrl' >\
        ...
        <img src='{{$window.browzine.pdfIcon}}' class='browzine-pdf-icon' style='margin-bottom: -3px; margin-right: 2.8px;' aria-hidden='true' width='12' height='16' />\
      ...
      <a class='browzine-web-link' href='{{$ctrl.browzineWebLink}}' target='_blank'>\
          <img src='{{$window.browzine.bookIcon}}' class='browzine-book-icon' style='margin-bottom: -2px; margin-right: 2.5px;' aria-hidden='true' width='15' height='15'/>\
